# Project 1 - Android-InstagramPhoto

Android-InstagramPhoto is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
<img src='android-InstagramPhoto.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
